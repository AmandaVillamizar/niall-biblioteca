...
Partial Public Class Database1DataSet
    ...
    Partial Public Class Tabla1DataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Overloads Function AddTabla1Row(ByVal Titulo As String, ByVal Autor As String, ByVal Genero_literario As String, ByVal Anio_de_publicacion As Date) As Tabla1Row
            Dim rowTabla1Row As Tabla1Row = CType(Me.NewRow,Tabla1Row)
            Dim columnValuesArray() As Object = New Object() {Nothing, Titulo, Autor, Genero_literario, Anio_de_publicacion}
    ...
    Partial Public Class Tabla1Row
        ...
        Public Property Titulo() As String
            Get
                Try 
                    Return CType(Me(Me.tableTabla1.TituloColumn),String)
                Catch e As Global.System.InvalidCastException
                    Throw New Global.System.Data.StrongTypingException("El valor de la columna 'Titulo' de la tabla 'Tabla1' es DBNull.", e)
                End Try
            End Get
            Set
                Me(Me.tableTabla1.TituloColumn) = value
            End Set
        End Property
        ...
        Public Property Genero_literario() As String
            Get
                Try 
                    Return CType(Me(Me.tableTabla1.Genero_literarioColumn),String)
                Catch e As Global.System.InvalidCastException
                    Throw New Global.System.Data.StrongTypingException("El valor de la columna 'Genero literario' de la tabla 'Tabla1' es DBNull.", e)
                End Try
            End Get
            Set
                Me(Me.tableTabla1.Genero_literarioColumn) = value
            End Set
        End Property
        ...
        Public Function IsTituloNull() As Boolean
            Return Me.IsNull(Me.tableTabla1.TituloColumn)
        End Function
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Sub SetTituloNull()
            Me(Me.tableTabla1.TituloColumn) = Global.System.Convert.DBNull
        End Sub
        ...
        Public Function IsGenero_literarioNull() As Boolean
            Return Me.IsNull(Me.tableTabla1.Genero_literarioColumn)
        End Function
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Sub SetGenero_literarioNull()
            Me(Me.tableTabla1.Genero_literarioColumn) = Global.System.Convert.DBNull
        End Sub
...
Namespace Database1DataSetTableAdapters
    ...
    Partial Public Class Tabla1TableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM `Tabla1` WHERE ((`Id` = ?) AND ((? = 1 AND `Titulo` IS NULL) OR (`Tit"& _ 
                "ulo` = ?)) AND ((? = 1 AND `Autor` IS NULL) OR (`Autor` = ?)) AND ((? = 1 AND `G"& _ 
                "enero literario` IS NULL) OR (`Genero literario` = ?)) AND ((? = 1 AND `Anio de "& _ 
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO `Tabla1` (`Titulo`, `Autor`, `Genero literario`, `Anio de publicacion"& _ 
                "`) VALUES (?, ?, ?, ?)"
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE `Tabla1` SET `Titulo` = ?, `Autor` = ?, `Genero literario` = ?, `Anio de p"& _ 
                "ublicacion` = ? WHERE ((`Id` = ?) AND ((? = 1 AND `Titulo` IS NULL) OR (`Titulo`"& _ 
                " = ?)) AND ((? = 1 AND `Autor` IS NULL) OR (`Autor` = ?)) AND ((? = 1 AND `Gener"& _ 
                "o literario` IS NULL) OR (`Genero literario` = ?)) AND ((? = 1 AND `Anio de publ"& _ 
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT Id, Titulo, Autor, [Genero literario], [Anio de publicacion] FROM Tabla1"
        ...
        Public Overloads Overridable Function Delete(ByVal Original_Id As Integer, ByVal Original_Titulo As String, ByVal Original_Autor As String, ByVal Original_Genero_literario As String, ByVal Original_Anio_de_publicacion As Global.System.Nullable(Of Date)) As Integer
            ...
            Else
                ...
                Me.Adapter.DeleteCommand.Parameters(6).Value = CType(Original_Genero_literario,String)
            End If
        ...
        Public Overloads Overridable Function Insert(ByVal Titulo As String, ByVal Autor As String, ByVal Genero_literario As String, ByVal Anio_de_publicacion As Global.System.Nullable(Of Date)) As Integer
            ...
            Else
                Me.Adapter.InsertCommand.Parameters(2).Value = CType(Genero_literario,String)
            End If
        ...
        Public Overloads Overridable Function Update(ByVal Titulo As String, ByVal Autor As String, ByVal Genero_literario As String, ByVal Anio_de_publicacion As Global.System.Nullable(Of Date), ByVal Original_Id As Integer, ByVal Original_Titulo As String, ByVal Original_Autor As String, ByVal Original_Genero_literario As String, ByVal Original_Anio_de_publicacion As Global.System.Nullable(Of Date)) As Integer
            If (Titulo Is Nothing) Then
            ...
            Else
                Me.Adapter.UpdateCommand.Parameters(2).Value = CType(Genero_literario,String)
            End If
            If (Anio_de_publicacion.HasValue = true) Then
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(10).Value = CType(Original_Genero_literario,String)
            End If
            If (Original_Anio_de_publicacion.HasValue = true) Then
